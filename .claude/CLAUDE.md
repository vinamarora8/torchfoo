...
- `torchfoo/module.py` — module utilities (`make_ddp`: SyncBatchNorm conversion + DistributedDataParallel)
- `torchfoo/__init__.py` exports `distributed` (also aliased as `dist`) and `module`
